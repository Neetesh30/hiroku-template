...
function themesflat_custom_styles( $custom ) {
    ...
    $scheme_color = themesflat_choose_opt( 'scheme_color' );
     if ( $scheme_color !='' ) {
		...
		$custom .= '.wrap-video .flat-control a:hover, input:focus, select:focus, textarea:focus, .woocommerce-message,
		.testimonial-sliders.style5 .owl-item.active.center blockquote { border-color:' . esc_attr($scheme_color) . '!important;}'."\n";

		$custom .= '.testimonial-sliders.style5 .testmonial-arrow { border-color:' . esc_attr($scheme_color) . ' transparent transparent transparent }'."\n";
		...
		$custom .= '.themesflat_iconbox.style7.active.inline-right:hover .icon > span { color :' . esc_attr($scheme_color) . '!important;}'."\n";
