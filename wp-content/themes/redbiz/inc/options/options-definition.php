...
function themesflat_page_options_fields() {
	...
	$options['page_title_heading'] = array(
		'type' => 'heading',
		'section' => 'general',
		'title' => esc_html__( 'Page Title', 'redbiz' ),
		);

	$options['enable_custom_page_title'] = array(
		'type'    => 'power',
		'title'   => esc_html__( 'Enable Custom Page Title', 'redbiz' ),
		'section' => 'general',
		'children' => array('page_title_background_image'),
		'default' => false
		);

	$options['page_title_background_image'] = array(
		'type' => 'single-image-control',
		'title'   => esc_html__( 'Page Title Background Image', 'redbiz' ),
		'section' => 'general',
		'default' => themesflat_get_opt('page_title_background_image')
		);
