...
function themesflat_setup() {
	 ...
	 * to change 'redbiz' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'redbiz', THEMESFLAT_DIR . '/languages' );
	...
	add_image_size( 'themesflat-recent-news-thumb', 132, 132, true );		
	add_image_size( 'themesflat-portfolio-thumb', 370, 245, true );	
    add_image_size( 'themesflat-blog-listsmall', 750, 430, true );
	add_image_size( 'themesflat-blog', 1170, 537, true );	
	add_image_size( 'themesflat-blog-grid', 750, 469, true );	
	add_image_size( 'themesflat-blog-single', 1170, 780, true );	
	add_image_size( 'themesflat-blog-full-width', 1170, 523, true );
    add_image_size( 'themesflat-portfolio-grid', 750, 750, true );
    add_image_size( 'themesflat-portfolio-related', 500, 331, true );
	add_image_size( 'themesflat-case-single', 1140, 460, true );	
	add_image_size( 'themesflat-case-singles', 750, 420, true );
    add_image_size( 'themesflat-case-masonry', 750, 1028, true );
	add_image_size( 'themesflat-testimonial', 74, 74, true );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'redbiz' ),
		'footer' => esc_html__( 'Footer Menu', 'redbiz' ),
		'bottom' => esc_html__( 'Bottom Menu', 'redbiz' )
	) );
...
function themesflat_widgets_init() {
	...
	register_sidebar( array(
        'name'          => esc_html__( 'Blog Sidebar', 'redbiz' ),
        'id'            => 'blog-sidebar',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer1.', 'redbiz' ),
	...
	register_sidebar( array(
        'name'          => esc_html__( 'Page Sidebar', 'redbiz' ),
        'id'            => 'page-sidebar',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer1.', 'redbiz' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Page Sidebar Single', 'redbiz' ),
    ...
    //Sidebar Woocommerce
    register_sidebar( array(
        'name'          => esc_html__( 'Woocommerce Sidebar', 'redbiz' ),
        'id'            => 'woo-sidebar',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Woocommerce Sidebar.', 'redbiz' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
    ...
    //Sidebar footer
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Widget 1', 'redbiz' ),
        'id'            => 'footer-1',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer1.', 'redbiz' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Widget 2', 'redbiz' ),
        'id'            => 'footer-2',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer2.', 'redbiz' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Widget 3', 'redbiz' ),
        'id'            => 'footer-3',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer3.', 'redbiz' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Widget 4', 'redbiz' ),
        'id'            => 'footer-4',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer4.', 'redbiz' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Widget 5', 'redbiz' ),
        'id'            => 'footer-5',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer5.', 'redbiz' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
...
function themesflat_scripts() {
	...
	wp_enqueue_style( 'font-awesome', THEMESFLAT_LINK . 'css/font-awesome.css' ); 
    wp_enqueue_style( 'font-elegant', THEMESFLAT_LINK . 'css/font-elegant.css' );
    wp_enqueue_style( 'icomoon', THEMESFLAT_LINK . 'css/icomoon.css' );
    ...
    wp_enqueue_style( 'segment7', THEMESFLAT_LINK . 'css/segment7.css' );
    wp_enqueue_style( 'flexslider-css', THEMESFLAT_LINK . 'css/flexslider.css' );
	...
	// Load the html5 shiv..	
	wp_enqueue_script( 'html5shiv', THEMESFLAT_LINK . 'js/html5shiv.js', array('jquery'), '1.3.0' ,true);	
    ...
    wp_enqueue_script( 'jquery-magnific-popup', THEMESFLAT_LINK . 'js/jquery.magnific-popup.min.js', array(), '1.0.0', true );
	wp_enqueue_script( 'waypoints', THEMESFLAT_LINK . 'js/jquery-waypoints.js', array(),'1.3' ,true);
	wp_enqueue_script( 'matchmedia', THEMESFLAT_LINK . 'js/matchMedia.js', array(),'1.2',true);
	wp_enqueue_script( 'jquery-fitvids', THEMESFLAT_LINK . 'js/jquery.fitvids.js', array(),'1.1',true);
    wp_enqueue_script( 'owl-carousel', THEMESFLAT_LINK . 'js/owl.carousel.js', array(),'1.1',true);
    wp_enqueue_script( 'countdown', THEMESFLAT_LINK . 'js/countdown.js', array(),'1.1',true);
    wp_enqueue_script( 'jquery-flexslider', THEMESFLAT_LINK . 'js/jquery.flexslider-min.js', array(),'2.6.0',true);
    ...
    if ( class_exists( 'woocommerce' ) ) {
        ...
        wp_enqueue_script( 'shop-woocommerce-js', THEMESFLAT_LINK . 'js/shop-woocommerce.js', array(),'1.1',true);
    }
...
function themesflat_vc_iconpicker_base_register_css(){
    wp_register_style('vc-ionicons', THEMESFLAT_LINK. 'css/font-ionicons.css');
     wp_register_style('vc-icomoon', THEMESFLAT_LINK. 'css/icomoon.css');
    wp_register_style('vc-eleganticons', THEMESFLAT_LINK. 'css/font-elegant.css');
    wp_register_style('vc-themifyicons', THEMESFLAT_LINK. 'css/themify-icons.css');
}
...
function themesflat_vc_iconpicker_editor_jscss(){
    wp_enqueue_style( 'vc-ionicons' );
    wp_enqueue_style( 'vc-icomoon' );
    wp_enqueue_style( 'vc-eleganticons' );
    wp_enqueue_style( 'vc-themifyicons' );
}
...
function themesflat_load_customizer_style() {   
    ...
    wp_register_style( 'font-awesome', THEMESFLAT_LINK .'css/font-awesome.css', false, '1.0.0' );   
