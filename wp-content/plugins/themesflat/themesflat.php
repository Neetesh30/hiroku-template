...
if ( 'redbiz' == $theme->name || 'redbiz' == $theme->parent_theme ) {
	...
	if ( function_exists( 'visual_composer' ) ) {	
		...
		require_once THEMESFLAT_PATH . '/includes/shortcodes/progress-bar.php';

		require_once THEMESFLAT_PATH . '/includes/shortcodes/vegas-slider.php';

		require_once THEMESFLAT_PATH . '/includes/shortcodes/textanimation.php';
...
require_once THEMESFLAT_PATH . '/includes/admin/sample-data.php';
...
if ( ! function_exists( 'themesflat_shortcode_register_assets' ) ) {
	...
	function themesflat_shortcode_register_assets() {		
		...
		wp_enqueue_style( 'textanimation', plugins_url('assets/css/textanimation.css', __FILE__), array() );

		wp_enqueue_style( 'jquery-fancybox', plugins_url('assets/css/jquery.fancybox.css', __FILE__), array() );

		wp_enqueue_style( 'vegas-style', plugins_url('assets/css/vegas.css', __FILE__), array() );

		wp_enqueue_style( 'ytplayer-style', plugins_url('assets/css/ytplayer.css', __FILE__), array() );
		...
		wp_register_script( 'vegas-slider', plugins_url('assets/3rd/vegas.js', __FILE__), array(), '2.4.0', true );

		wp_register_script( 'textanimation', plugins_url('assets/3rd/textanimation.js', __FILE__), array(), '1.0', true );

		wp_register_script( 'typed', plugins_url('assets/3rd/typed.js', __FILE__), array(), '1.1', true );

		wp_register_script( 'ytplayer', plugins_url('assets/3rd/ytplayer.js', __FILE__), array(), '19.54', true );
