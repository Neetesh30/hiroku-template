...
<head>
    ...
    <link rel="icon" type="image/png" href="..\assets\images\frontpage\favicon\favicon-32x32.png" sizes="32x32">
    <link rel="icon" type="image/png" href="..\assets\images\frontpage\favicon\favicon-64x64.png" sizes="64x64">
    <link rel="apple-touch-icon" href="..\assets\images\frontpage\favicon\favicon-180x180.png">
    <link rel="shortcut icon" href="..\assets\images\frontpage\favicon\favicon-32x32.png">
    <meta property="og:logo" content="/assets/images/frontpage/favicon/favicon-180x180.png" size="180x180">
    ...
    <meta property="og:image" content="/assets/images/frontpage/share.png">
    ...
    <meta name="twitter:image" content="/assets/images/frontpage/share.png">
    ...
    <a class="logo" name="Home" href="index.php">
        ...
        <svg viewbox="0 0 57 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M19.4076 18.4V0.300001H16.0826V18.4H19.4076Z"></path>
            <path d="M26.2924 18.4V6.1H22.9674V18.4H26.2924ZM22.5674 2.075C22.5674 3.175 23.4924 4.1 24.6174 4.1C25.7674 4.1 26.6674 3.175 26.6674 2.075C26.6674 0.925 25.7674 0 24.6174 0C23.4924 0 22.5674 0.925 22.5674 2.075Z"></path>
            <path d="M33.1771 11.325C33.1771 9.9 34.0271 8.775 35.4771 8.775C37.0771 8.775 37.7521 9.85 37.7521 11.225V18.4H41.0771V10.65C41.0771 7.95 39.6771 5.775 36.6271 5.775C35.3021 5.775 33.8271 6.35 33.0771 7.625V6.1H29.8521V18.4H33.1771V11.325Z"></path>
            <path d="M56.3768 6.1H52.0268L47.7768 10.675V0.300001H44.4518V18.4H47.7768V15.15L49.1518 13.7L52.4018 18.4H56.4768L51.4518 11.275L56.3768 6.1Z"></path>
        </svg>
    </a>
    <nav>
        <div class="header_menu">
            ...
            <a name="Contact" href="mailto:plink@mollie.com" target="_self">Contact</a>
                    ...
                    <a id="login" name="Login with Mollie" class="button" href="/login" target="_self" rel="nofollow">Login with Mollie</a>
            </nav>
    ...
    <div class="video-background prllx">
        <div class="home_intro_videos">
            <video class="intro" muted="" playsinline="">
                <source src="..\assets\images\frontpage\intro.webm" type="video/webm">
                <source src="..\assets\images\frontpage\intro.mp4" type="video/mp4">
            </video>
            <video class="intro-loop" muted="" playsinline="" loop="">
                <source src="..\assets\images\frontpage\loop.webm" type="video/webm">
                <source src="..\assets\images\frontpage\loop.mp4" type="video/mp4">
            </video>
        </div>
    </div>
    ...
    <div class="home_titles">
        ...
        <h2 class="baseline">86% of our payment requests get paid within 12 hours.</h2>
    </div>
</section>
    ...
    <div class="home_create_coins">
        <div class="coins coin_1 prllx" data-prllx-d="-50">
            <div class="prllx-elt">
                <video class="" autoplay="" loop="" muted="" playsinline="" preload="none">
                    <source src="..\assets\images\frontpage\coin_3.webm" type="video/webm">
                    <source src="..\assets\images\frontpage\coin_3.mp4" type="video/mp4">
                </video>
            </div>
        </div>
        <div class="coins coin_2 prllx" data-prllx-d="-20">
            <div class="prllx-elt">
                <video class="" autoplay="" loop="" muted="" playsinline="" preload="none">
                    <source src="..\assets\images\frontpage\coin_3.webm" type="video/webm">
                    <source src="..\assets\images\frontpage\coin_2.mp4" type="video/mp4">
                </video>
            </div>
        </div>
        <div class="coins coin_3 prllx" data-prllx-d="50">
            <div class="prllx-elt">
                <video class="" autoplay="" loop="" muted="" playsinline="" preload="none">
                    <source src="..\assets\images\frontpage\coin_1.webm" type="video/webm">
                    <source src="..\assets\images\frontpage\coin_1.mp4" type="video/mp4">
                </video>
            </div>
        </div>
    </div>
    <div class="home_titles block-anim no-slide just-below">
        ...
        <h2 class="baseline"><p>Make a simple payment link in <strong>5 seconds.</strong><br> Use our powerful features to customize your request.</p>
        </h2>
    </div>
    ...
    <div class="home_send_video prllx" data-prllx-d="50">
        <video class="lazy" autoplay="" loop="" muted="" playsinline="">
            <source data-src="/assets/images/frontpage/mail_loop.webm" type="video/webm">
            <source data-src="/assets/images/frontpage/mail_loop.mp4" type="video/mp4">
        </video>
    </div>
    <div class="home_titles">
...
<section class="home_scan">
        ...
        <div class="prllx-elt">
            <div class="home_scan_qr-code">
                <div class="home_scan_qr-code-image">
                    <img class="lazy" alt="QR CODE" sizes="20vw" data-src="/assets/images/frontpage/plink_hp_qr.png" data-srcset="/assets/images/frontpage/plink_hp_qr-320x0-c-default.png 320w,
			/assets/images/frontpage/plink_hp_qr-640x0-c-default.png 640w,
			/assets/images/frontpage/plink_hp_qr-1024x0-c-default.png 1024w,
			/assets/images/frontpage/plink_hp_qr-1280x0-c-default.png 1280w,
			/assets/images/frontpage/plink_hp_qr-1440x0-c-default.png 1440w,
			/assets/images/frontpage/plink_hp_qr-1920x0-c-default.png 1920w">
    ...
    <div class="prllx" data-prllx-d="10" data-prllx-offset="2">
        <div class="home_payment_logos scroll-loop prllx-elt">
            <div>
					<span>
						<img class="" alt="" sizes="100vw" src="..\assets\images\frontpage\payment-methods_copy_2_2x.png" srcset="..\assets\images\frontpage\payment-methods_copy_2_2x-320x0-c-default.png 320w,
			..\assets\images\frontpage\payment-methods_copy_2_2x-640x0-c-default.png 640w,
			..\assets\images\frontpage\payment-methods_copy_2_2x-1024x0-c-default.png 1024w,
			..\assets\images\frontpage\payment-methods_copy_2_2x-1280x0-c-default.png 1280w,
			..\assets\images\frontpage\payment-methods_copy_2_2x-1440x0-c-default.png 1440w,
			..\assets\images\frontpage\payment-methods_copy_2_2x-1920x0-c-default.png 1920w">
                    </span>
            </div>
        </div>
    </div>
    ...
    <div class="home_titles">
        <h1 class="title">Start for<br>free today</h1>
                    <a class="footer_cta button" rel="nofollow" name="Login with mollie" href="/login" target="_blank" rel="noopener"><h2>Login with Mollie</h2></a>
            </div>
    <div class="footer_bottom">
        <div class="powered-by">Plink is powered by <a href="https://www.mollie.com" target="_blank" rel="noopener">Mollie</a></div>
        <div class="copyright">Copyright © 2020 Mollie B.V. All rights reserved.</div>
        <nav>
